...
const experiences = [
  {
    ...
    responsibilities: [
      ...
      'Built a personal portfolio website, a calculator application, and a responsive landing page.',
      'Managed project source code using GitHub for version control.',
    ],
  },
  {
    company: 'Teachnook',
    ...
    color: '#8B5CF6',
    responsibilities: [
      'Developed a responsive electric vehicle web application using React, CSS, and structural design tools.',
      'Built reusable UI components and implemented responsive, user-friendly page layouts.',
      'Implemented dynamic frontend functionality and interactive product pages.',
      'Maintained project source code using GitHub and deployed the application live on Netlify.',
    ],
  },
]
